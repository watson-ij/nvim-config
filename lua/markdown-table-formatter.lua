...
M.format_markdown_table = function()
...
M.setup = function()
  vim.api.nvim_create_user_command('FormatTable', M.format_markdown_table, {
  ...
  vim.api.nvim_create_autocmd('FileType', {
    pattern = { 'markdown', 'md' },
    callback = function()
      vim.keymap.set('n', '<localleader>f', M.format_markdown_table, {
        buffer = true,
